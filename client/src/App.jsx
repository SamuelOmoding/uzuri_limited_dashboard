      ...
      <div className="app overflow-hidden" style={ThemeStyles}>
        ...
        <main className="content">
          ...
          <Routes>
            ...
            <Route
              path="/Dashboard"
              element={<Dashboard ThemeStyles={ThemeStyles} />}
            />
            <Route
              path="/RegisterClient"
              element={<RegisterClient ThemeStyles={ThemeStyles} />}
            />
            <Route
              path="/FeeCalculator"
            ...
            <Route
              path="/ClientList"
              element={<ClientList ThemeStyles={ThemeStyles} />}
            />
            <Route
              path="/ServicesList"
              element={<ServicesList ThemeStyles={ThemeStyles} />}
            />
          </Routes>
        </main>
      </div>
